...
local smallfont = love.graphics.newFont("res/lcd.ttf", 16)
local middlefont=love.graphics.newFont("res/lcd.ttf", 25)
local imagebuttonfont = love.graphics.newFont("res/lcd.ttf", 40)
...
-- list
skin.controls.list_body_color                       = {0,0,0,50}

-- scrollarea
skin.controls.scrollarea_body_color                 = {0, 0, 0, 50}

-- scrollbody
skin.controls.scrollbody_body_color                 = {0, 0, 0, 50}

-- panel
skin.controls.panel_body_color                      = {0, 0, 0, 200}
...
-- columnlist
skin.controls.columnlist_body_color                 = {0,0,0,50}

-- columlistarea
skin.controls.columnlistarea_body_color             = {0,0,0,50}

-- columnlistheader
skin.controls.columnlistheader_text_down_color      = {255, 255, 255, 255}
skin.controls.columnlistheader_text_nohover_color   = {0, 255, 0, 200}
skin.controls.columnlistheader_text_hover_color     = {255, 255, 255, 255}
skin.controls.columnlistheader_text_font            = smallfont

-- columnlistrow
skin.controls.columnlistrow_body1_color             = {0, 0, 0, 50}
skin.controls.columnlistrow_body2_color             = {50,50, 50, 50}
skin.controls.columnlistrow_body_selected_color     = {0, 198, 0, 50}
skin.controls.columnlistrow_body_hover_color        = {0, 217, 0, 50}
skin.controls.columnlistrow_text_color              = {0, 200, 0, 255}
skin.controls.columnlistrow_text_hover_color        = {100, 255, 100, 255}
skin.controls.columnlistrow_text_selected_color     = {155, 255, 155, 255}

-- modalbackground
skin.controls.modalbackground_body_color            = {0, 0, 0, 50}
...
function skin.DrawScrollBar(object)
	...
	local hover = object:GetHover()
	local bartype = object:GetBarType()
	local bodydowncolor = {0,0,0,50}
	local bodyhovercolor = {0,0,0,50}
	local bodynohvercolor = {0,0,0,50}
	if dragging then
...
function skin.DrawGrid(object)
	...
	if object.showOuterBorder then
		love.graphics.setColor(bordercolor)
		skin.OutlinedRectangle(x, y, width, height)
	end
	...
	for i=1, object.rows do
		for n=1, object.columns do
			...
			if object.showInnerBorder then
				love.graphics.setColor(bordercolor)
