local ghost=Class("ghost",Ship_base) --这个 要改“”中的名称 跟飞机名字对应就行了
...
function ghost:initialize(side,x,y,rot)
	...
	self.engineSys={
		...
		{posX=-9*self.size,posY=-1*self.size,rot=0,anim=res.engineFire[2]()},
	}
	...
	self.abilities[1]={
		...
		quad={12,11}, --技能图标 在icon里面找
		text="move", --技能文档 
		func=function(obj)  --技能的函数 
			print("warning!!!")
		end,
		small=true,
